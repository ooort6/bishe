<template>
  <div class="main">
        ...
        <el-dropdown style="float: right;">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item @click.native="updatePassword"
              ><i style="padding-right: 8px" class="el-icon-share"></i>修改密码
            </el-dropdown-item>
            <el-dropdown-item @click.native="logout"
              ><i style="padding-right: 8px" class="el-icon-star-off"></i
              >退出系统
            </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      ...
      <div class="aside">
        <div class="menu">
          ...
          <div class="menu-body">
            <div
              class="item1"
              v-for="(item, index) in generateMenu"
    ...
    <el-dialog title="修改密码" :visible.sync="addDialogVisible" width="30%">
      <el-form
        :model="userForm"
        ref="userForm"
