<template>
  <div style="display: flex;flex-direction: column;align-items: center">
    ...
    <el-card style="width: 80%">
      <div
        style="width: 100%;display: flex;flex-direction: row;justify-content: space-around;margin-bottom: 20px"
      >
      ...
      <el-table :data="tableData" style="width: 100%;margin-bottom: 20px">
        ...
        <el-table-column prop="checkYear" label="学年" width="180">
        </el-table-column>
        <el-table-column prop="name" label="姓名" align="center">
        </el-table-column>
        <el-table-column prop="stuNo" label="学号" width="180">
        </el-table-column>
        <el-table-column prop="college" align="center" label="学院" width="180">
        </el-table-column>
        <el-table-column prop="major" align="center" label="专业" width="180">
        </el-table-column>
        <el-table-column prop="grade" label="班级" align="center">
        </el-table-column>
        <el-table-column fixed="right" align="center" label="操作" width="230">
          <template slot-scope="scope">
            <el-button @click.native.prevent="showRow(scope.row)" size="small">
              查看
            </el-button>
            <el-button
        ...
        >
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="选择学年" prop="checkYear">
                <el-select
                  v-model="checkInfoData.checkYear"
                  :disabled="disable"
                  :value="checkInfoData.checkYear"
                  @change="judgeCheckIsExist"
                >
                  <el-option
                    v-for="item in checkDataOptions"
                    :key="item.label"
                    :label="item.label"
                    :value="item.label"
                  ></el-option>
            ...
            <el-col :span="8">
              <el-form-item label="体检日期" prop="checkTime">
                <el-date-picker
                  v-model="checkInfoData.checkTime"
                  :disabled="disable"
                ></el-date-picker>
              </el-form-item>
            </el-col>
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="文化程度" prop="cultureLevel">
                    <el-input
                      v-model="checkInfoData.cultureLevel"
                      :disabled="disable"
                      @input="change($event)"
                    ></el-input>
                  </el-form-item>
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="职业" prop="occupation">
                    <el-input
                      v-model="checkInfoData.occupation"
                      :disabled="disable"
                      @input="change($event)"
                    ></el-input>
                  </el-form-item>
                ...
                <el-col :span="8">
                  <el-form-item label="籍贯" prop="nativePlace">
                    <el-input
                      v-model="checkInfoData.nativePlace"
                      :disabled="disable"
                      @input="change($event)"
                    ></el-input>
                  </el-form-item>
          ...
          <el-form-item label="现家庭住址" label-width="10%">
            <el-input
              type="textarea"
              :disabled="disable"
              v-model="checkInfoData.presentAddress"
              @input="change($event)"
            ></el-input>
          </el-form-item>
          <el-form-item label="毕业学校或工作单位" label-width="10%">
            <el-input
              type="textarea"
              :disabled="disable"
              v-model="checkInfoData.workPlace"
              @input="change($event)"
            ></el-input>
          </el-form-item>
          <el-form-item label="既往医史" label-width="10%">
            <el-input
              type="textarea"
              :disabled="disable"
              v-model="checkInfoData.historyCheck"
              @input="change($event)"
            ></el-input>
          </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="视力-左" prop="leftView">
                <el-input
                  :disabled="disable"
                  type="number"
                  v-model="checkInfoData.leftView"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="视力-右" prop="rightView">
                <el-input
                  :disabled="disable"
                  type="number"
                  v-model="checkInfoData.rightView"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item
                label="矫正视力-左"
                label-width="30%"
                prop="correctLeftView"
              >
                <el-input
                  :disabled="disable"
                  type="number"
                  v-model="checkInfoData.correctLeftView"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item
                label="矫正视力-右"
                label-width="30%"
                prop="correctRightView"
              >
                <el-input
                  :disabled="disable"
                  type="number"
                  v-model="checkInfoData.correctRightView"
                ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-form-item label="其他眼疾" label-width="10%">
            <el-input
              :disabled="disable"
              v-model="checkInfoData.otherEyesSick"
              <!-- :class="{
        'red-text': checkInfoData.otherEyesSick.length > 2
      }" -->
            ></el-input>
          </el-form-item>
          <el-row>
            <el-col :span="12">
              <el-form-item label="色觉检查-彩色图案及编码" label-width="30%">
                <el-input
                  :disabled="disable"
                  v-model="checkInfoData.colorOrCode"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="色觉检查-单色识别" label-width="30%">
                <el-input
                  :disabled="disable"
                  v-model="checkInfoData.singleColorJudge"
                ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-form-item label="医师签字" label-width="10%">
            <el-input
              :disabled="disable"
              v-model="checkInfoData.signForEyes"
            ></el-input>
          </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="听力-左" prop="leftAudition">
                <el-input
                  :disabled="disable"
                  type="number"
                  v-model="checkInfoData.leftAudition"
                >
            ...
            <el-col :span="12">
              <el-form-item label="听力-右" prop="rightAudition">
                <el-input
                  :disabled="disable"
                  type="number"
                  v-model="checkInfoData.rightAudition"
                >
                  <template slot="append"
                    >db</template
                  >
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="鼻及鼻窦疾病">
                <el-input
                  :disabled="disable"
                  v-model="checkInfoData.paranasalSinus"
                ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-form-item label="医师签字" label-width="10%">
            <el-input
              :disabled="disable"
              v-model="checkInfoData.signForEar"
            ></el-input>
          </el-form-item>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="龋  齿">
                <el-input
                  :disabled="disable"
                  v-model="checkInfoData.toothSick"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="缺  齿">
                <el-input
                  :disabled="disable"
                  v-model="checkInfoData.hypodontia"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="齿  槽">
                <el-input
                  :disabled="disable"
                  v-model="checkInfoData.toothPlace"
                ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-form-item label="其他" label-width="10%">
            <el-input
              :disabled="disable"
              v-model="checkInfoData.otherSenseSick"
            ></el-input>
          </el-form-item>
          <el-form-item label="医师签字" label-width="10%">
            <el-input
              :disabled="disable"
              v-model="checkInfoData.signForMouth"
            ></el-input>
          </el-form-item>
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="腰围">
                <el-input
                  v-model="checkInfoData.waistline"
                  type="number"
                  :disabled="disable"
                >
                  <template slot="append"
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="甲状腺">
                <el-input
                  v-model="checkInfoData.glandulaThyroidea"
                  :disabled="disable"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="脊  柱">
                <el-input
                  v-model="checkInfoData.spineBackbone"
                  :disabled="disable"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="关  节">
                <el-input
                  v-model="checkInfoData.arthrosis"
                  :disabled="disable"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-form-item label="其他" label-width="10%">
            <el-input
              v-model="checkInfoData.otherSurgerySick"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          <el-row>
            <el-col :span="12">
              <el-form-item label="血压">
                <el-input
                  :disabled="disable"
                  type="number"
                  v-model="checkInfoData.bloodPressure"
                >
                  <template slot="append"
                    >mmHg</template
                  >
          ...
          <el-form-item label="医师签字" label-width="10%">
            <el-input
              v-model="checkInfoData.signForSurgery"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="其他" label-width="10%">
            <el-input
              v-model="checkInfoData.otherInternalSick"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          <el-form-item label="医师签字" label-width="10%">
            <el-input
              v-model="checkInfoData.signForInternal"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="化验检查" label-width="10%">
            <el-input
              type="textarea"
              v-model="checkInfoData.assayCheck"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          <el-form-item label="化验员签字" label-width="10%">
            <el-input
              v-model="checkInfoData.signForAssay"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="化验胸部放射检查" label-width="10%">
            <el-input
              type="textarea"
              v-model="checkInfoData.chestCheck"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          <el-form-item label="医师签字" label-width="10%">
            <el-input
              v-model="checkInfoData.signForChest"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="其他检查" label-width="10%">
            <el-input
              type="textarea"
              v-model="checkInfoData.otherCheck"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          <el-form-item label="检查结论" label-width="10%">
            <el-input
              type="textarea"
              v-model="checkInfoData.checkResult"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          <el-form-item label="负责医师签字" label-width="10%">
            <el-input
              v-model="checkInfoData.signForResult"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          <el-form-item label="检查医院意见" label-width="10%">
            <el-input
              v-model="checkInfoData.suggestForCheck"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          <el-form-item label="盖章" label-width="10%">
            <el-input
              v-model="checkInfoData.sealer"
              :disabled="disable"
            ></el-input>
          </el-form-item>
          ...
          <template>
            <el-form-item align="right">
              <el-button type="success" @click="disable = !disable"
                >编辑</el-button
              >
              <el-button
                :disabled="!disable"
                type="primary"
                @click="saveData(checkInfoData)"
                >保存</el-button
              >
  ...
  methods: {
    ...
    initData() {
      ...
      this.$http.post("/checkInfo/page", this.searchData).then((res) => {
        if (res.status === 200) {
          console.log("res.data: " , res.data.list.length)
    ...
    judgeCheckIsExist() {
      if (
        this.checkInfoData.checkYear === "" ||
        this.checkInfoData.checkYear == null
      ) {
        this.$message.warning("请选择需要学年");
      } else {
        this.$http
          .get("/checkInfo/judgeCheckIsExist", {
            params: {
              userId: this.user.id,
