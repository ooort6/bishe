<template>
  <div style="display: flex;flex-direction: column;align-items: center">
    ...
    <el-card style="width: 80%">
      ...
      <el-table :data="tableData" style="width: 100%;margin-bottom: 20px">
        ...
        <el-table-column fixed="right" align="center" label="操作" width="230">
          <template slot-scope="scope">
            <el-button @click.native.prevent="showRow(scope.$index, tableData)" size="small">
              查看
            </el-button>
            <el-button @click.native.prevent="updateRow(scope.$index, tableData)" size="small">
              编辑
            </el-button>
            <el-button @click.native.prevent="deleteRow(scope.$index, tableData)" size="small">
              删除
            </el-button>
            <el-button @click.native.prevent="aiSuggestRow(scope.$index, tableData)" size="small">
              AI建议
            </el-button>
          </template>
        </el-table-column>
      ...
      <div>
        <el-pagination style="float: left;margin-bottom: 20px" @size-change="handleSizeChange"
          @current-change="handleCurrentChange" :current-page="searchData.pageNum" :page-sizes="[10, 15, 20, 30]"
          :page-size="searchData.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="searchData.total">
        </el-pagination>
      </div>
    </el-card>
    <el-dialog :title="title" width="80%" :modal="false" :before-close="handleClose" :visible.sync="dialogVisible">
      <div style="width: 100%;display: flex;align-items: center;flex-direction: column">
        <el-form :model="checkInfoData" ref="checkInfoData" label-width="25%" style="width: 90%;" label-position="left">
          <!--<el-row>
            <el-col :span="8">
          ...
          <el-alert title="学生基本信息" type="success" :closable="false" style="margin-bottom: 10px"></el-alert>
          <el-row>
            <el-col :span="18">
              <el-row>
                <el-col :span="8">
          ...
          <div v-if="showFlag1">
            <el-alert title="五官科检查信息--眼科" type="warning" :closable="false" style="margin-bottom: 10px"></el-alert>
            <el-row>
              <el-col :span="6">
            ...
            <el-alert title="五官科检查信息--耳喉鼻科" type="warning" :closable="false" style="margin-bottom: 10px"></el-alert>
            <el-row>
              <el-col :span="12">
            ...
            <el-alert title="五官科检查信息--口腔科" type="warning" :closable="false" style="margin-bottom: 10px"></el-alert>
            <el-row>
              <el-col :span="8">
          ...
          <div v-if="showFlag2">
            <el-alert title="外科检查信息" type="info" :closable="false" style="margin-bottom: 10px"></el-alert>
            <el-row>
              <el-col :span="6">
          ...
          <div v-if="showFlag3">
            <el-alert title="内科检查信息" type="info" :closable="false" style="margin-bottom: 10px"></el-alert>
          ...
          <div v-if="showFlag4">
            <el-alert title="化验检查信息" type="success" :closable="false" style="margin-bottom: 10px"></el-alert>
            ...
            <el-alert title="化验胸部放射检查信息" type="success" :closable="false" style="margin-bottom: 10px"></el-alert>
            ...
            <el-alert title="其他检查信息" type="success" :closable="false" style="margin-bottom: 10px"></el-alert>
          ...
          <template>
            <el-form-item align="right">
              <el-button type="success" @click="disable = !disable">编辑</el-button>
    ...
    <el-dialog title="查看学生健康档案" width="85%" :modal="false" :before-close="handleClose"
...
export default {
  ...
  methods: {
    ...
    aiSuggestRow(index, data) {
      console.log('aiData',data);
      // this.gpt35Api('肾虚')
    },
    // async gpt35Api(messages) {
    //   try {
    //     const client = new OpenAI({
    //       apiKey: 'sk-fc5xEORggw3lfZ4m1QDDz0xgii9iRBfePmpcsu01QBgJGcLN', // 默认会从环境变量 OPENAI_API_KEY 读取
    ...
    judgeCheckIsExist() {
      if (
        this.checkInfoData.userId === "" ||
        this.checkInfoData.userId == null
      ) {
